...
# Hide sidebar navigation and default multipage menu for participants
st.markdown(
    """
    <style>
...
# Read routing values
# Priority:
# 1) session_state (after controller routes)
# 2) query params (direct test access)
# =========================
qp = st.query_params
...
def get_route_value(name: str) -> str:

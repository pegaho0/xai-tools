...
TOUR_CONFIG = {
    ...
    "max_shap_display": 12,
    "visual_caption": "This visual explanation shows which inputs most strongly supported this tour recommendation.",
    "text_caption": "This text explanation summarizes the most influential factors behind the tour recommendation.",
}
...
TOUR_CONFIG["result_formatter"] = result_formatter